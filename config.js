System.config({
  ...
  bundles: {
    "app-build.js": [
      ...
      "components/dropdown.html!github:systemjs/plugin-text@0.0.8.js",
      "components/dropdown.js",
      "components/dropdown.js.map!github:systemjs/plugin-text@0.0.8.js",
      "components/example.html!github:systemjs/plugin-text@0.0.8.js",
      "components/example.js",
      "components/example.js.map!github:systemjs/plugin-text@0.0.8.js",
      "components/syntax-highlight.js",
      "components/syntax-highlight.js.map!github:systemjs/plugin-text@0.0.8.js",
      "dropdown/dropdown.html!github:systemjs/plugin-text@0.0.8.js",
      "dropdown/dropdown.js",
      "dropdown/dropdown.js.map!github:systemjs/plugin-text@0.0.8.js",
      "dropdown/examples/example-1.html!github:systemjs/plugin-text@0.0.8.js",
      "dropdown/examples/example-1.js",
      "dropdown/examples/example-1.js.map!github:systemjs/plugin-text@0.0.8.js",
      "dropdown/examples/example-2.html!github:systemjs/plugin-text@0.0.8.js",
      "dropdown/examples/example-2.js",
      "dropdown/examples/example-2.js.map!github:systemjs/plugin-text@0.0.8.js",
      "main.js",
